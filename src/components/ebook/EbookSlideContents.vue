    ...
    <div class="ebook-slide-contents">
        <div class="slide-contents-search-wrapper">
            <div class="slide-contents-search-input-wrapper">
                ...
                <input class="slide-contents-search-input" type="text" v-model="searchText" :placeholder="$t('book.searchHint')" @click="showSearchPage()" @keyup.enter.exact="search()">
            </div>
            <div class="slide-contents-search-cancel" v-if="searchVisible" @click="hiddenSearchPage()">{{$t('book.cancel')}}</div>
        </div>
        ...
        .slide-contents-book-wrapper {
            ...
            .slide-contents-book-info-wrapper {
                ...
                .slide-contents-book-title {
                    // 对于缩略显示一定要指定宽度 375*0.85=318.75然后-30=288.75然后-20=268.75然后-45=223.75然后-70=153.75
                    // width: px2rem(153.75);
                    font-size: px2rem(14);
